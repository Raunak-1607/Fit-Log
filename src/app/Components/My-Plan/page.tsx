        ...
        <div className="flex justify-between items-center mb-5">
          ...
          <div className="flex bg-[#15181e] border border-[#252a33] rounded-xl p-1">
            ...
            <button
              ...
              className={`px-5 py-2 rounded-lg text-sm ${activeTab === "today"
            ...
            <button
              ...
              className={`px-5 py-2 rounded-lg text-sm ${activeTab === "saved"
                  ? "bg-[#20252d] text-white"
                  : "text-gray-500"
                }`}
            >
          ...
          <div className="flex items-center gap-3">
            ...
            <select className="bg-[#13161c] border border-[#252a33] rounded-lg px-4 py-2 text-sm">
